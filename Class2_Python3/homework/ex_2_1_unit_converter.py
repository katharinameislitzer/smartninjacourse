def unit_converter(source_unit: str, target_unit: str, value: float) -> float: # or str
    # write code here
...
if __name__ == '__main__':
   ...
   #print("Hello, this is the awesome unit converter - we convert km in miles for you")
    #source_unit = (input("Please enter km here: "))
   # print(source_unit)